...
> [!NOTE]
> **这是上游 README 的存档副本（描述的是完整版布局，不是本仓库）。**
> 本仓库（lite 档）的说明请看 [`README.md`](README.md) / [`README_zh.md`](README_zh.md)。
> 原文中的相对链接指向上游仓库结构，在本仓库内**可能失效**——如需原样浏览，请访问
> <https://github.com/Vincentwei1021/anything2explainer>。
>
> Archived copy of the upstream README. It describes the **full** tier, not this repository.
> See [`README.md`](README.md) for this package.
...
**English** | [简体中文](UPSTREAM_README_zh.md)
